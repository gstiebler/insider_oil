...
getAmbientalLicensesQuery: function(test) {
   const reqQueryValues = {
    ...
    test.equal('LPS 101/2015', resQueryValues.records[0].license);
    test.equal('Pesquisa Sísmica Marítima 2D na Bacia de Pelotas - Programa Pelotas Fase II', resQueryValues.records[0].enterprise);
    
    test.equal('ABio 560/2014', resQueryValues.records[1].license);
