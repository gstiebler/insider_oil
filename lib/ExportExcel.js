...
function exportExcel(records, dataSourceName) {
	const fieldsArray = [];
    var excelParams = dsParams[dataSourceName].excelParams;
...
exports.main = function(dataSourceName) {
    ...
    try {
        ...
        exportExcel(records, dataSourceName);
    } catch(e) {
