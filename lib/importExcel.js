            ...
            for( var row = 1; row <= range.e.r; row++ ) {
                ...
                if( record ) {
                    try {
                        ...
                        invalidStatus.push( error.message ); // pseudoerror. It's about not finding a record
                    }
                } else {
                    record = {};
                    try {
                        ...
                        invalidStatus.push( 'Registro: ' + row + ': ' + error.message ); // pseudoerror. It's about not finding a record
                    }
                }
            }
